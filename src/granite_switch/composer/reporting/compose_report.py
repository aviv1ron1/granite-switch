...
def _print_summary(
    ...
    if adapter_mapping and "target_params" in adapter_mapping:
        ...
        zero_initialized_adapter_targets = sorted(all_adapter_targets - target_connected)
    ...
    if zero_initialized_adapter_targets:
        ...
        print("  (Expected: These are adapter modules missing from source adapters or zero-padded)")
